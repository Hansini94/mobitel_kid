...
Class Districts extends CI_Controller {
    ...
    private $table_name = "tbl_districts";
    private $page_id = "9";
    private $redirect_path = "adminpanel/master/districts";
    ...
    public function index() {
        ...
        $this->load->view('adminpanel/masterdata/districts_view', $data);
    ...
    public function save_data($data = '') {
        ...
        $vDistrictName = $this->input->post('vDistrictName', TRUE);        
        ...
        if ($cSaveStatus === 'E') {
            if ($this->common_model->update_saved_data($this->table_name)) {
                ...
                redirect(base_url() . 'adminpanel/master/districts');
            } else {
                $this->session->set_flashdata('message_error', 'Save fail!');
                redirect(base_url() . 'adminpanel/master/districts');
            }
        } else {
            if ($this->Master_data_model->district_name_exists($vDistrictName,'0')) {
