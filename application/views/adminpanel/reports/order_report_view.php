                ...
                <div class="x_panel" style=" padding-top:0px;">
                    <div class="x_content">
                        ...
                        <select id='sel_status' style="width:30% !important;float: left" class="form-control">
                         ...
                         <!-- Name -->
                            <input class="form-control"  style="width:30% !important;float: right"  type="text" id="searchEmpName" placeholder="Search Employee Name">
                        </div>
       ...
       var userDataTable = $('#devices').DataTable({
         ...
         'ajax': {
            ...
            'data': function(data){
               ...
               data.searchEmpName = $('#searchEmpName').val();
            }
         },
         'columns': [
