        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style=" padding-top:0px;">    
                    ...
                    <form class="form-inline" action="<?php echo base_url('adminpanel/submission/submissions/search_data'); ?>" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        ...
                                        <input type="date" id="from_date" name="from_date"  class="form-control col-md-7 col-xs-12" value="" data-date-format='yyyy-mm-dd' placeholder="YYYY-MM-DD" data-parsley-type="date" autocomplete="off"> 
...
<div class="clearfix"></div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="date" id="to_date" name="to_date"  class="form-control col-md-7 col-xs-12" value="" data-date-format='yyyy-mm-dd' placeholder="YYYY-MM-DD" data-parsley-type="date" autocomplete="off"> 
                    ...
                    <div class="row">
                        ...
                        <!-- <input type="text" id="file_path" name="file_path" value="<?php if(isset($file_path)){echo $file_path;} ?>" class="form-control">                              -->
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <footer>
                                <a href="<?php if(isset($file_path)){ echo base_url() . $file_path ;}?>" download>
                                    <button id="download" name="download" type="button" class="btn btn-success">Download</button>
                                    </a>
                                <button name="reset" id="reset" type="button" class="btn btn-default" onclick="document.location.href = '<?php echo base_url('adminpanel/submission/submissions/index'); ?>';">Reset</button>
                                <button id="button1id" name="button1id" type="submit" class="btn btn-primary">Search</button>                                
                            </footer> 
                        </div>
                        </form>
                    </div>    
