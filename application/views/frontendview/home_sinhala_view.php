          ...
          <form id="submission_form" name="submission_form" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
            <div class="row">            
              ...
              <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 form-group" >
                <input type="text" class="form-control mb-3" id="tFullNameSin" name="tFullName" placeholder="දරුවාගේ සම්පූර්ණ නම">
              ...
              <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6 col-sm-12 col-12 form-group">
                <select class="form-select mb-3" aria-label="Default select example" id="iDivSecretariatIdSin" name="iDivSecretariatIdSin">
                  <option value="0" selected>ප්‍රාදේශීය ලේකම් කොට්ඨාශය *</option>
                  <?php                                               
                    // foreach ($sub_category as $sub_categories) {
                    //   $sid = $sub_categories->id;
                    //   echo '<option value="' . $sid . '">' . $sub_categories->vSubcategoryName . '</option>';
                ...
                <div id="DivSecretariat_div" style="display:none; color:#F00; margin-top: -3px">ප්‍රාදේශීය ලේකම් කොට්ඨාශය තෝරන්න</div>
              </div> 

              <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 form-group" >
                <input type="text" class="form-control mb-3" id="tSchoolSin" name="tSchoolSin" placeholder="ඉගෙනුම ලබන පාසල *">
                <div id="School_div" style="display:none; color:#F00; margin-top: -3px"> ඉගෙනුම ලබන පාසල ඇතුලත් කරන්න </div>
              </div>

              <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6 col-sm-12 col-12 form-group">
                <select class="form-select mb-3" aria-label="Default select example" id="iGradeSin" name="iGradeSin">
                  <option value="0" selected>ඉගෙනුම ලබන ශ්‍රේණිය *</option>
                  <?php                                               
                ...
                <div id="District_div" style="display:none; color:#F00; margin-top: -3px">ඉගෙනුම ලබන ශ්‍රේණිය තෝරන්න </div>
              </div>
              ...
              <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <button type="button" class="btn btn-primary green_btn mb-3" style="width: auto;" onClick="checkemptySinhala();"  id="submission_submit_sin" >දැන් ඉදිරිපත් කරන්න</button>
                <!--  -->
