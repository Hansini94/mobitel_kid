        ...
        <div class="modal-body">
          <img src="<?php echo base_url("assets/frontend/images/thank.gif"); ?>" alt="" class="img-fluid mx-auto d-block" width="200px;">
            <p class="mb-3" style="text-align: center;">
              Thank you for Connecting with us, Your Reference Number is
              <br>
              <div id="ref_no" style="text-align: center;font-size: 24px; color: red; font-family: sans-serif;"></div>
            </p>
...
<div class="clearfix"></div>
<section id="form-submit" class="margin_auto ">
<div class="container">
          ...
          <form id="submission_form" name="submission_form" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
            <div class="row">            
              ...
              <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 form-group" >
                <input type="text" class="form-control mb-3" id="tFullName" name="tFullName" placeholder="Name in Full *">
              ...
              <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6 col-sm-12 col-12 form-group">
                <select class="form-select mb-3" aria-label="Default select example" id="iDivSecretariatId" name="iDivSecretariatId">
                  <option value="0" selected>Divisional Secretariat *</option>
                  <?php                                               
                    // foreach ($sub_category as $sub_categories) {
                    //   $sid = $sub_categories->id;
                    //   echo '<option value="' . $sid . '">' . $sub_categories->vSubcategoryName . '</option>';
                ...
                <div id="DivSecretariat_div" style="display:none; color:#F00; margin-top: -3px">Select a Divisional Secretariat</div>
              </div> 

              <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 form-group" >
                <input type="text" class="form-control mb-3" id="tSchool" name="tSchool" placeholder="School *">
                <div id="School_div" style="display:none; color:#F00; margin-top: -3px"> Enter School </div>
              </div>

              <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6 col-sm-12 col-12 form-group">
                <select class="form-select mb-3" aria-label="Default select example" id="iGrade" name="iGrade">
                ...
                <div id="Grade_div" style="display:none; color:#F00; margin-top: -3px">Select a Grade</div>
              </div>
              ...
              <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id='wait_message' style='display: none;text-align: right;color: red;font-size: 13px;line-height: 1.42857143;'>
                    Please wait...
                </div>   
...
<div class="modal-loading"><!--delay loading section--></div>
</section>
<!-- ======================= -->
