              ...
              <div class="form_blue_box shadow rounded">
                ...
                <div class="lang_div">
                  <div class="position-relative">
                    <div class="position-absolute top-0 end-0">
                        <a href="<?php echo base_url('Terms-of-use-En');?>"><button class="btn btn-primary blue_white_btn">En</button></a>
                ...
                <div class="row m-auto">
                  ...
                  <h1 class="heading" style="color: #ffffff; padding-left: 0px;" data-aos="fade-down">விதிமுறைகள் மற்றும் நிபந்தனைகள்</h1>
                  <p style="padding-left: 0px;" data-aos="fade-down">
                   <?php echo $terms->tContent_tam; ?>
                  </p>
