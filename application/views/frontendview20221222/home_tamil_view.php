            ...
            <div class="row">            
             ...
             <div id="Subcategory_div" style="display:none; color:#F00; margin-top: -3px">ஒரு துணை வகையைத் தேர்ந்தெடுக்கவும்</div>
              ...
              <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <button type="button" class="btn btn-primary green_btn mb-3" style="width: auto;"  data-bs-target="#exampleModalToggle" data-bs-toggle="modal" data-bs-dismiss="modal" id="submission_submit" disabled>இப்போது சமர்ப்பிக்கவும்</button>
                <!--  -->
